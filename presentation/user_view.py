...
class UserView(AbstractView):
        ...
        self.__questions = [
            {
                ...
                "name": "choix",
                "message": (
                    f"Hello {self.user.nom}" if self.langue == "anglais" else f"Bonjour {self.user.nom}\n"
                ),
                "choices": [
                    ...
                    "Suivre ses candidatures"  if self.langue == "français" else "Check applications",
    ...
    def make_choice(self):
        ...
        elif choix == ("Offres sauvegardées" if self.langue == "français" else "Saved Offers"):
            return OffreView(user=self.user, langue=self.langue)
        elif choix == ("Recherches sauvegardées" if self.langue == "français" else "Saved searches"):
            return ARechercheView(user=self.user, langue=self.langue)
        elif choix == ("Lancer une recherche" if self.langue == "français" else "Start a new search"):
            return RechercheView(user=self.user, langue=self.langue)
        elif choix == ("Vérifier ses informations personnelles" if self.langue == "français" else "Check personal information"):
            return InfoView(user=self.user, langue=self.langue)
        elif choix == ("Changer la langue" if self.langue == "français" else "Change the language"):
            new_langue = "français" if self.langue == "anglais" else "anglais"
            return UserView(user=self.user, langue=new_langue)
        elif choix == "Suivre ses candidatures" if self.langue == "français" else "Check applications":
