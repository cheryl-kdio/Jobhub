...
class Utilisateur(Memory) : # Création classe Utilisateur
    ...
    def create_account(self): # Création de la fonction créer un compte
        ...
        while id in Memory().iterer_donnees() : # Verif ID n'existe pas déjà dans notre stockage 
        ...
        Memory().add_db(id,[name_user,password]) # Ajout de l'utilisateur à notre stockage 
